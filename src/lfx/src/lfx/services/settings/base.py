"""Composed ``Settings`` class for Flow.
...
class Settings(BaseSettings):
    ...
    """If set to True, Flow will expose Prometheus metrics."""
    prometheus_port: int = 9090
    """The port on which Flow will expose Prometheus metrics. 9090 is the default port."""
    ...
    """If set to True, Flow will auto save flows."""
    auto_saving_interval: int = 1000
    """The interval in ms at which Flow will auto save flows."""
    ...
    """If set to False, Flow will not enable the MCP server."""
    mcp_server_enable_progress_notifications: bool = False
    """If set to False, Flow will not send progress notifications in the MCP server."""
    ...
    """If set to False, Flow will not start the MCP Composer service."""
