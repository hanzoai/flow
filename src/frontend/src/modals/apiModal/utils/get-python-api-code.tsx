...
# API Configuration
try:
    api_key = os.environ["HANZOFLOW_API_KEY"]
except KeyError:
    raise ValueError("HANZOFLOW_API_KEY environment variable not found. Please set your API key in the environment variables.")\n`
    : ""
