...
export const HANZOFLOW_ACCESS_TOKEN_EXPIRE_SECONDS = 60 * 60 - 60 * 60 * 0.1;
export const HANZOFLOW_ACCESS_TOKEN_EXPIRE_SECONDS_ENV =
...
export const IS_AUTO_LOGIN =
  !process?.env?.HANZOFLOW_AUTO_LOGIN ||
  String(process?.env?.HANZOFLOW_AUTO_LOGIN)?.toLowerCase() !== "false";
