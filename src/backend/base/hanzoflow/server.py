...
from hanzoflow.logging.logger import InterceptHandler


class HanzoflowUvicornWorker(UvicornWorker):
...
class HanzoflowApplication(BaseApplication):
    def __init__(self, app, options=None) -> None:
        self.options = options or {}

        self.options["worker_class"] = "hanzoflow.server.HanzoflowUvicornWorker"
