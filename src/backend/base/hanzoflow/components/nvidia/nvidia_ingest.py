...
from hanzoflow.io import BoolInput, DropdownInput, FileInput, IntInput, MessageTextInput, Output
...
class NvidiaIngestComponent(Component):
    ...
    try:
        ...
        msg = (
            ...
            "Please install them using your package manager. (e.g. uv pip install hanzoflow[nv-ingest])"
        )
        file_types = [msg]
