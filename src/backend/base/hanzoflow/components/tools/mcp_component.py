...
from hanzoflow.base.mcp.util import (
    MCPSseClient,
    MCPStdioClient,
...
from hanzoflow.inputs import DropdownInput
from hanzoflow.inputs.inputs import InputTypes
from hanzoflow.io import MessageTextInput, Output, TabInput
from hanzoflow.io.schema import schema_to_hanzoflow_inputs
from hanzoflow.logging import logger
from hanzoflow.schema import Message
...
class MCPToolsComponent(Component):
    ...
    async def _validate_schema_inputs(self, tool_obj) -> list[InputTypes]:
        ...
        try:
            ...
            schema_inputs = schema_to_hanzoflow_inputs(input_schema)
    ...
    def get_inputs_for_all_tools(self, tools: list) -> dict:
        ...
        for tool in tools:
            if not tool or not hasattr(tool, "name"):
                continue
            try:
                input_schema = schema_to_hanzoflow_inputs(create_input_schema_from_json_schema(tool.inputSchema))
