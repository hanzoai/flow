...
from hanzoflow.io import BoolInput, DictInput, HandleInput, IntInput, SecretStrInput, StrInput, TableInput
from hanzoflow.logging import logger
from hanzoflow.schema import Data
from hanzoflow.schema.table import EditMode
...
class AstraDBToolComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.hanzoflow.org/Components/components-tools#astra-db-tool"
    icon: str = "AstraDB"
