...
from hanzoflow.inputs import IntInput, MultilineInput, NestedDictInput, SecretStrInput, StrInput
...
class GleanSearchAPIComponent(LCToolComponent):
    ...
    documentation: str = "https://docs.hanzoflow.org/Components/components-tools#glean-search-api"
    icon: str = "Glean"
