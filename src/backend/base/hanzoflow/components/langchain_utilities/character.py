...
from hanzoflow.inputs import DataInput, IntInput, MessageTextInput
...
class CharacterTextSplitterComponent(LCTextSplitterComponent):
    ...
    documentation = "https://docs.hanzoflow.org/components/text-splitters#charactertextsplitter"
