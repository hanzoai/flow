...
from hanzoflow.inputs.inputs import MessageTextInput
from hanzoflow.memory import aget_messages, astore_message
...
class MessageStoreComponent(Component):
    ...
    description = "Stores a chat message or text into Hanzoflow tables or an external memory."
    ...
    inputs = [
        ...
        HandleInput(
            ...
            input_types=["Memory"],
            info="The external memory to store the message. If empty, it will use the Hanzoflow tables.",
        ),
        MessageTextInput(
            name="sender",
            display_name="Sender",
