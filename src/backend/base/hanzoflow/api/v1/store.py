...
from hanzoflow.api.utils import CurrentActiveUser, check_hanzoflow_version
from hanzoflow.services.auth import utils as auth_utils
from hanzoflow.services.deps import get_settings_service, get_store_service
from hanzoflow.services.store.exceptions import CustomError
from hanzoflow.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_hanzoflow_version(component)
