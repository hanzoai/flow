...
from hanzoflow.api.utils import CurrentActiveUser, DbSession
from hanzoflow.api.v1.chat import build_flow_and_stream
...
from hanzoflow.schema.properties import Properties
from hanzoflow.services.auth.utils import api_key_header, api_key_query, api_key_security, get_current_user_by_jwt
...
from hanzoflow.services.deps import get_variable_service, session_scope
                ...
                await client_websocket.send_json(
                    {
                        "type": "error",
                        "code": "hanzoflow_auth",
                        "message": "You must pass a valid Hanzoflow token or cookie.",
                    }
                )
                return
                    ...
                    while True:
                        ...
                        if msg.get("type") == "input_audio_buffer.append":
                            ...
                            if num_audio_samples > AUDIO_SAMPLE_THRESHOLD:
                                ...
                                log_event(msg, "↑")
                                num_audio_samples = 0
                        elif msg.get("type") == "hanzoflow.elevenlabs.config":
                            logger.info(f"hanzoflow.elevenlabs.config {msg}")
