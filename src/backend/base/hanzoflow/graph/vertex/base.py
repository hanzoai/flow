...
from hanzoflow.graph.schema import INPUT_COMPONENTS, OUTPUT_COMPONENTS, InterfaceComponentTypes, ResultData
from hanzoflow.graph.utils import UnbuiltObject, UnbuiltResult, log_transaction
from hanzoflow.graph.vertex.param_handler import ParameterHandler
from hanzoflow.interface import initialize
from hanzoflow.interface.listing import lazy_load_dict
from hanzoflow.schema.artifact import ArtifactType
from hanzoflow.schema.data import Data
from hanzoflow.schema.message import Message
from hanzoflow.schema.schema import INPUT_FIELD_NAME, OutputValue, build_output_logs
from hanzoflow.services.deps import get_storage_service
from hanzoflow.utils.schemas import ChatOutputResponse
from hanzoflow.utils.util import sync_to_async
...
if TYPE_CHECKING:
    ...
    from hanzoflow.graph.vertex.schema import NodeData
...
class Vertex:
    ...
    async def build(
        ...
        **kwargs,
        ...
        from hanzoflow.interface.components import ensure_component_loaded
