...
from hanzoflow.graph.schema import CHAT_COMPONENTS
from hanzoflow.utils.lazy_load import LazyLoadDictBase

if TYPE_CHECKING:
    from hanzoflow.graph.vertex.base import Vertex
    from hanzoflow.graph.vertex.vertex_types import CustomComponentVertex
...
def _import_vertex_types():
    from hanzoflow.graph.vertex import vertex_types
