...
from hanzoflow.interface.utils import extract_input_variables_from_prompt
...
from hanzoflow.services.database.models.transactions.crud import log_transaction as crud_log_transaction
from hanzoflow.services.database.models.transactions.model import TransactionBase
from hanzoflow.services.database.models.vertex_builds.crud import log_vertex_build as crud_log_vertex_build
from hanzoflow.services.database.models.vertex_builds.model import VertexBuildBase
from hanzoflow.services.database.utils import session_getter
from hanzoflow.services.deps import get_db_service, get_settings_service

if TYPE_CHECKING:
    from hanzoflow.api.v1.schemas import ResultDataResponse
...
def has_chat_output(vertices: dict[Vertex, int]):
    from hanzoflow.graph.schema import InterfaceComponentTypes
