...
from hanzoflow.inputs.validators import CoalesceBool
from hanzoflow.schema.data import Data
from hanzoflow.schema.message import Message
from hanzoflow.services.database.models.message.model import MessageBase
    ...
    def validate_value(cls, v: Any, _info):
        ...
        if not isinstance(v, list):
            msg = (
                ...
                "- A Data object (Hanzoflow's internal data structure)\n"
            )
        ...
        for i, item in enumerate(v):
            if not isinstance(item, dict | Data):
                msg = (
                    ...
                    "- A Data object (Hanzoflow's internal data structure for passing data between components)\n"
...
class MessageTextInput(StrInput, MetadataTraceMixin, InputTraceMixin, ToolModeMixin):
    """Represents a text input component for the Hanzoflow system.

    This component is used to handle text inputs in the Hanzoflow system.
