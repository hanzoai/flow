"""File-based storage service for flow artifacts."""
...
class FileStorageService(StorageService):
    """A service class for handling file-based storage operations.

    Stores files under data_dir/flow_id/file_name using async I/O.
    """
    ...
    async def save_file(self, flow_id: str, file_name: str, data: bytes) -> None:
        ...
        Raises:
            FileNotFoundError: If the parent path cannot be created.
    ...
    async def teardown(self) -> None:
        """Perform cleanup operations when the service is torn down."""
        # No specific teardown actions required for file storage
        pass
