...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("hanzoflow.project.name", self.project_name)
            self.root_span.set_attribute("hanzoflow.flow.name", self.flow_name)
            self.root_span.set_attribute("hanzoflow.flow.id", self.flow_id)
