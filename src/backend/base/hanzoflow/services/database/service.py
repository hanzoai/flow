...
from hanzoflow.services.database import models
from hanzoflow.services.database.models.user.crud import get_user_by_username
from hanzoflow.services.database.utils import Result, TableResults
from hanzoflow.services.deps import get_settings_service
from hanzoflow.services.utils import teardown_superuser
...
class DatabaseService(Service):
    ...
    def __init__(self, settings_service: SettingsService):
        ...
        hanzoflow_dir = Path(__file__).parent.parent.parent
        self.script_location = hanzoflow_dir / "alembic"
        self.alembic_cfg_path = hanzoflow_dir / "alembic.ini"
        ...
        if Path(alembic_log_file).is_absolute():
            ...
            self.alembic_log_path = Path(hanzoflow_dir) / alembic_log_file
