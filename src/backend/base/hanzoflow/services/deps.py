...
from hanzoflow.services.schema import ServiceType
...
if TYPE_CHECKING:
    ...
    from hanzoflow.services.cache.service import AsyncBaseCacheService, CacheService
    from hanzoflow.services.chat.service import ChatService
    from hanzoflow.services.database.service import DatabaseService
    ...
    from hanzoflow.services.socket.service import SocketIOService
    from hanzoflow.services.state.service import StateService
    ...
    from hanzoflow.services.telemetry.service import TelemetryService
    from hanzoflow.services.tracing.service import TracingService
    from hanzoflow.services.variable.service import VariableService
...
def get_telemetry_service() -> TelemetryService:
    ...
    """
    from hanzoflow.services.telemetry.factory import TelemetryServiceFactory
...
def get_tracing_service() -> TracingService:
    ...
    """
    from hanzoflow.services.tracing.factory import TracingServiceFactory
...
def get_state_service() -> StateService:
    ...
    """
    from hanzoflow.services.state.factory import StateServiceFactory
...
def get_storage_service() -> StorageService:
    ...
    """
    from hanzoflow.services.storage.factory import StorageServiceFactory
...
def get_variable_service() -> VariableService:
    ...
    """
    from hanzoflow.services.variable.factory import VariableServiceFactory
...
def get_settings_service() -> SettingsService:
    ...
    """
    from hanzoflow.services.settings.factory import SettingsServiceFactory
...
def get_db_service() -> DatabaseService:
    ...
    """
    from hanzoflow.services.database.factory import DatabaseServiceFactory
...
def get_cache_service() -> CacheService | AsyncBaseCacheService:
    ...
    """
    from hanzoflow.services.cache.factory import CacheServiceFactory
...
def get_shared_component_cache_service() -> CacheService:
    ...
    Returns:
        The cache service instance.
    """
    from hanzoflow.services.shared_component_cache.factory import SharedComponentCacheServiceFactory
...
def get_session_service() -> SessionService:
    ...
    """
    from hanzoflow.services.session.factory import SessionServiceFactory
...
def get_task_service() -> TaskService:
    ...
    """
    from hanzoflow.services.task.factory import TaskServiceFactory
...
def get_queue_service() -> JobQueueService:
    ...
    from hanzoflow.services.job_queue.factory import JobQueueServiceFactory
