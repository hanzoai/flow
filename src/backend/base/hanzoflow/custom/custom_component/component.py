...
from hanzoflow.base.tools.constants import (
...
from hanzoflow.custom.tree_visitor import RequiredInputsVisitor
from hanzoflow.exceptions.component import StreamingError
from hanzoflow.field_typing import Tool  # noqa: TC001 Needed by _add_toolkit_output
from hanzoflow.graph.state.model import create_state_model
from hanzoflow.graph.utils import has_chat_output
from hanzoflow.helpers.custom import format_type
from hanzoflow.memory import astore_message, aupdate_messages, delete_message
from hanzoflow.schema.artifact import get_artifact_type, post_process_raw
from hanzoflow.schema.data import Data
from hanzoflow.schema.message import ErrorMessage, Message
from hanzoflow.schema.properties import Source
from hanzoflow.schema.table import FieldParserType, TableOptions
from hanzoflow.services.tracing.schema import Log
from hanzoflow.template.field.base import UNDEFINED, Input, Output
from hanzoflow.template.frontend_node.custom_components import ComponentFrontendNode
from hanzoflow.utils.async_helpers import run_until_complete
from hanzoflow.utils.util import find_closest_match
...
if TYPE_CHECKING:
    ...
    from hanzoflow.inputs.inputs import InputTypes
...
class Component(CustomComponent):
    ...
    async def _build_tools_metadata_input(self):
        ...
        try:
            from hanzoflow.io import TableInput
        except ImportError as e:
            msg = "Failed to import TableInput from hanzoflow.io"
