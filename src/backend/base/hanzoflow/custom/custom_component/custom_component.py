...
from hanzoflow.custom.custom_component.base_component import BaseComponent
from hanzoflow.helpers.flow import list_flows, load_flow, run_flow
from hanzoflow.schema import Data
from hanzoflow.services.deps import get_storage_service, get_variable_service, session_scope
from hanzoflow.services.storage.service import StorageService
from hanzoflow.template.utils import update_frontend_node_with_template_values
from hanzoflow.type_extraction.type_extraction import post_process_type
...
class CustomComponent(BaseComponent):
    """Represents a custom component in Hanzoflow.
