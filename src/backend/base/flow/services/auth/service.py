...
from flow.services.auth.constants import AUTO_LOGIN_ERROR, AUTO_LOGIN_WARNING
...
from flow.services.database.models.user.crud import (
    get_user_by_id,
...
class AuthService(BaseAuthService):
    """Default Flow authentication service (implements LFX BaseAuthService)."""
    ...
    async def _authenticate_with_token(self, token: str, db: AsyncSession) -> User:
        ...
        try:
            from flow.services.auth.iam_org import extract_org_from_jwt_payload, sync_user_org
