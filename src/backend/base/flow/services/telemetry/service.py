...
from flow.services.telemetry.opentelemetry import OpenTelemetry
...
class TelemetryService(Service):
    ...
    def _get_flow_desktop(self) -> bool:
    ...
    async def _send_email_telemetry(self) -> None:
        ...
        from flow.utils.registered_email_util import get_email_model
