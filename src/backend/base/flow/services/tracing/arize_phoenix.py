...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("flow.trace_name", self.trace_name)
            self.root_span.set_attribute("flow.trace_type", self.trace_type)
            self.root_span.set_attribute("flow.project_name", self.project_name)
            self.root_span.set_attribute("flow.trace_id", str(self.trace_id))
            self.root_span.set_attribute("flow.session_id", str(self.session_id))
            self.root_span.set_attribute("flow.flow_name", self.flow_name)
            self.root_span.set_attribute("flow.flow_id", self.flow_id)
