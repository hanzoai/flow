...
# Minimum PostgreSQL major version required by Hanzo Flow.
...
POSTGRESQL_VERSION_REQUIRED_MESSAGE = (
    f"Hanzo Flow requires PostgreSQL {MIN_POSTGRESQL_MAJOR_VERSION} or higher when using PostgreSQL as the database. "
    "The current PostgreSQL version does not support the syntax used by Hanzo Flow's schema. "
