...
from flow.services.utils import initialize_services, initialize_settings_service, teardown_services
from flow.utils.mcp_cleanup import cleanup_mcp_sessions
    ...
    async def lifespan(_app: FastAPI):
        ...
        try:
            ...
            if get_settings_service().settings.agentic_experience:
                from flow.api.utils.mcp.agentic_mcp import initialize_agentic_global_variables
            ...
            if get_settings_service().settings.agentic_experience:
                from flow.api.utils.mcp.agentic_mcp import auto_configure_agentic_mcp_server
            ...
            from flow.api.v1.mcp import start_streamable_http_manager
            from flow.api.v1.mcp_projects import start_project_task_group
            ...
            try:
                ...
                with shutdown_progress.step(1):
                    from flow.api.v1.mcp import stop_streamable_http_manager
                    from flow.api.v1.mcp_projects import stop_project_task_group
...
def create_app():
    ...
    if settings.mcp_server_enabled:
        from flow.api.v1 import mcp_router
...
def get_static_files_dir():
    """Get the static files directory relative to Flow's main.py file."""
