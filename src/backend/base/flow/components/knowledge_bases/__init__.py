"""Flow knowledge bases module - forwards to lfx.components.files_and_knowledge.
...
# This allows imports like: import flow.components.knowledge_bases.ingestion
_redirected_submodules = {
    # "flow.components.knowledge_bases.ingestion": "lfx.components.files_and_knowledge.ingestion",
    "flow.components.knowledge_bases.retrieval": "lfx.components.files_and_knowledge.retrieval",
}
