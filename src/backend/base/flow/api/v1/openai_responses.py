...
from flow.api.utils import extract_global_variables_from_headers
from flow.api.v1.endpoints import consume_and_yield, run_flow_generator, simple_run_flow
from flow.api.v1.schemas import SimplifiedAPIRequest
...
from flow.schema import (
    OpenAIErrorResponse,
    OpenAIResponsesRequest,
    OpenAIResponsesResponse,
    OpenAIResponsesStreamChunk,
)
from flow.schema.content_types import ToolContent
from flow.services.auth.utils import api_key_security
from flow.services.database.models.flow.model import FlowRead
from flow.services.database.models.user.model import UserRead
    ...
    *,
    ...
    if stream:
        ...
        async def openai_stream_generator() -> AsyncGenerator[str, None]:
            """Convert Flow events to OpenAI Responses API streaming format."""
...
async def create_response(
    ...
    the input through the specified Flow flow.
    ...
    # Extract global variables from X-FLOW-GLOBAL-VAR-* headers
