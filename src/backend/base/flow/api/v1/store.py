...
from flow.api.utils import CurrentActiveUser, check_flow_version
from flow.services.auth import utils as auth_utils
from flow.services.deps import get_settings_service, get_store_service
from flow.services.store.exceptions import CustomError
from flow.services.store.schema import (
...
async def share_component(
    ...
    try:
        await check_flow_version(component)
