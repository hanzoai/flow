...
from flow.api.utils import CurrentActiveUser, DbSession, extract_global_variables_from_headers, parse_value
...
from flow.events.event_manager import create_stream_tokens_event_manager
from flow.exceptions.api import APIException, InvalidChatInputError
from flow.exceptions.serialization import SerializationError
from flow.helpers.flow import get_flow_by_id_or_endpoint_name
...
from flow.services.database.models.flow.utils import get_all_webhook_components_in_flow
from flow.services.database.models.user.model import User, UserRead
from flow.services.deps import get_auth_service, get_session_service, get_settings_service, get_telemetry_service
from flow.services.event_manager import create_webhook_event_manager, webhook_event_manager
from flow.services.telemetry.schema import RunPayload
from flow.utils.compression import compress_response
from flow.utils.version import get_version_info

if TYPE_CHECKING:
    from flow.events.event_manager import EventManager
...
async def _run_flow_internal(
    *,
    ...
    # Extract request-level variables from headers with prefix X-FLOW-GLOBAL-VAR-*
...
async def simplified_run_flow(
    *,
    ...
    Notes:
        ...
        - Extracts global variables from HTTP headers with prefix X-FLOW-GLOBAL-VAR-*
