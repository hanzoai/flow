...
from flow.api.v1.schemas import Token
...
from flow.services.deps import get_auth_service, get_settings_service, get_variable_service
...
async def get_session(
    ...
    """
    from flow.services.auth.utils import oauth2_login
