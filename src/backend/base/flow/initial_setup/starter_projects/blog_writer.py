...
""")
    ...
    url_component.set(urls=["https://hanzo.ai/flow/", "https://docs.hanzo.ai/flow/"])
    ...
    text_input.set(
        input_value="Use the references above for style to write a new blog/tutorial about Flow and AI. "
