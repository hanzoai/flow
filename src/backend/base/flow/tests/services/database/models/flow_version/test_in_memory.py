...
import pytest
from flow.api.utils.flow_utils import cascade_delete_flow
from flow.services.database.models.deployment.crud import list_deployments_page
...
class TestVersionPruningRespectsLiveDeployments:
    async def test_orphan_attachment_does_not_pin_version_during_pruning(
        ...
        with patch(
            "flow.services.database.models.flow_version.crud.get_settings_service",
