#!/usr/bin/env python3
"""Diagnostic tool for remote Hanzo Flow instances.
...
def main():
    parser = argparse.ArgumentParser(description="Diagnose remote Hanzo Flow instance")
    parser.add_argument("--host", required=True, help="Hanzo Flow host URL")
    ...
    print(f"🔍 Diagnosing Hanzo Flow instance: {args.host}")
    print("=" * 60)
    ...
    if not connectivity_results["reachable"]:
        ...
        print("❌ Health check failed - Hanzo Flow may not be running properly")
