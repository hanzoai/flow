#!/usr/bin/env python3
"""Diagnostic tool for remote Flow instances.
...
def main():
    parser = argparse.ArgumentParser(description="Diagnose remote Flow instance")
    parser.add_argument("--host", required=True, help="Flow host URL")
    ...
    print(f"🔍 Diagnosing Flow instance: {args.host}")
    print("=" * 60)
    ...
    if not connectivity_results["reachable"]:
        ...
        print("❌ Health check failed - Flow may not be running properly")
