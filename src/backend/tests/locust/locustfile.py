...
class FlowRunUser(FastHttpUser):
    """FlowRunUser simulates users sending requests to the Hanzoflow run endpoint.
    ...
    Environment Variables:
      - HANZOFLOW_HOST: Base URL for the Hanzoflow server (default: http://localhost:7860)
    ...
    host = os.getenv("HANZOFLOW_HOST", "http://localhost:7860")
