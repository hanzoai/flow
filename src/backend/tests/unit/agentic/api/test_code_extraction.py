...
class TestValidateComponentCode:
    ...
    def test_validates_valid_component(self):
        """Should validate correct Flow component code."""
    ...
    def test_fails_for_non_component_code(self):
        """Should fail validation for code that's not a Flow component."""
...
Based on your request, I'll create a custom Flow component that performs sentiment analysis.
This component will:
1. Take text input
