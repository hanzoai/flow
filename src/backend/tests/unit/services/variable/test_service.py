...
import pytest
from hanzoflow.services.database.models.variable.model import VariableUpdate
...
from hanzoflow.services.variable.constants import CREDENTIAL_TYPE
from hanzoflow.services.variable.service import DatabaseVariableService
...
async def test_initialize_user_variables__not_found_variable(service, session: AsyncSession):
    with patch("hanzoflow.services.variable.service.DatabaseVariableService.create_variable") as m:
