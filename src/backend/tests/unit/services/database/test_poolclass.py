...
Issue: https://github.com/hanzoai/flow/issues/10231
PR: https://github.com/hanzoai/flow/pull/10232
...
class TestBuggyCode:
    ...
    def test_buggy_code_crashes_with_nullpool(self):
        ...
        When users set FLOW_DB_CONNECTION_SETTINGS={"poolclass": "NullPool"},
