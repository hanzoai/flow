...
import pytest
from hanzoflow.components.youtube.youtube_transcripts import YouTubeTranscriptsComponent
from hanzoflow.schema import Data, DataFrame, Message
...
class TestYouTubeTranscriptsComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("hanzoflow.components.youtube.youtube_transcripts.YoutubeLoader")
