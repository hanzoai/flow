...
import pytest
from hanzoflow.components.vectorstores.chroma import ChromaVectorStoreComponent
...
class TestChromaVectorStoreComponent(ComponentTestBaseWithoutClient):
    ...
    def default_kwargs(self, tmp_path: Path) -> dict[str, Any]:
        ...
        from hanzoflow.components.embeddings.openai import OpenAIEmbeddingsComponent
