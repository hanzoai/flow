...
import pytest
from hanzoflow.components.data import DirectoryComponent
...
class TestDirectoryComponent(ComponentTestBaseWithoutClient):
    ...
    @patch("hanzoflow.components.data.directory.parallel_load_data")
    @patch("hanzoflow.components.data.directory.retrieve_file_paths")
    @patch("hanzoflow.components.data.DirectoryComponent.resolve_path")
