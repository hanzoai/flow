...
class TestMigrationCompatibility:
    ...
    def test_script_encryption_matches_langflow(self, migrate_module):
        ...
        script_decrypted = migrate_module.decrypt_with_key(flow_encrypted, secret_key)
