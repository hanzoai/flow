...
:::tip
For more examples of the **Loop** component, try the **Research Translation Loop** template in Hanzo Flow, or see the video tutorial [Mastering the Loop Component & Agentic RAG in Hanzo Flow](https://www.youtube.com/watch?v=9Wx7WODSKTo).
:::
