...
The **Python Interpreter** component can only import packages that are already installed in your Hanzo Flow environment.
...
3. To pass a URL input to the **Python Interpreter** component, make the following changes to the code:
   ...
   The following example demonstrates these modifications.
    ...
    class PythonREPLComponent(Component):
        ...
        documentation: str = "https://docs.flow.org/python-interpreter"
