...
The schema is defined in [`data.py`](https://github.com/hanzoai/flow/blob/main/src/backend/base/flow/schema/data.py).
...
The schema is defined in [`dataframe.py`](https://github.com/hanzoai/flow/blob/main/src/backend/base/flow/schema/dataframe.py).

The following attributes are available:

- **Full pandas compatibility**: All pandas DataFrame methods and functionality are supported

- **Hanzo Flow integration**: Accepts lists of [`Data` objects](#data), dictionaries, or existing DataFrames.
...
The `Message` schema is defined in [`message.py`](https://github.com/hanzoai/flow/blob/main/src/backend/base/flow/schema/message.py).
