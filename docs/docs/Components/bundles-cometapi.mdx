...
description: Use CometAPI models in Hanzo Flow to generate text or output a Language Model for downstream Components.
---

import Icon from "@site/src/components/icon";

[Bundles](/components-bundle-components) contain custom components that support specific third-party integrations with Hanzo Flow.
...
3. In Hanzo Flow, add the **CometAPI** component to your flow.
