...
:::tip
The ALTK contains features called _components_. These are different from Hanzo Flow components. All components within ALTK are available through Hanzo Flow's **ALTK Agent** component.
:::
...
For an example of the ALTK component in Hanzo Flow, see the video tutorial [ALTK in Hanzo Flow: Reliably handle JSON responses in your AI agent](https://www.youtube.com/watch?v=YNwPBK_KxXY).
