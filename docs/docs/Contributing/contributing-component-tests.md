...
For example, if the file path for the component is `src/backend/base/hanzoflow/components/prompts/`, then the test file should be located at `src/backend/tests/unit/components/prompts`.
