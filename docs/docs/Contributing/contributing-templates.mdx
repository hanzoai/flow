...
Follow these best practices when submitting a template to Hanzo Flow.

For template formatting examples, see [`/starter_projects`](https://github.com/hanzoai/flow/tree/main/src/backend/base/flow/initial_setup/starter_projects) in the Hanzo Flow repository.

## Create a PR to submit your template

Follow these steps to submit your template:

1. Fork the [Hanzo Flow repository](https://github.com/hanzoai/flow) on GitHub.
...
4. Create a Pull Request (PR) from your fork to the main Hanzo Flow repository.
5. Include a screenshot of your template in the PR.

The Hanzo Flow team will review your PR, offer feedback, and, if approved, merge the template.
...
Don't use custom components that aren't part of the Hanzo Flow codebase.
...
For more information, see the Hanzo Flow repository's [template categories](https://github.com/hanzoai/flow/blob/main/src/frontend/src/modals/templatesModal/index.tsx#L27-L57).