...
- Hanzo Flow MCP client for Bob (IBM) and Claude Code
    ...
    For more information, see [Hanzo Flow MCP client for coding agents](../Agents/flow-mcp-client.mdx).
...
- Build components with **Hanzo Flow Assistant**
    ...
    **Hanzo Flow Assistant** is an in-app virtual assistant that can create components from natural language prompts directly within the Hanzo Flow workspace.
