...
The Hanzo Flow GitHub repository is an integral part of the [Hanzo Flow community](/contributing-community).

In addition to general assistance with Hanzo Flow, the repository is the best place to report bugs and request enhancements to ensure that they are tracked by Hanzo Flow maintainers.

## GitHub issues

The [Issues page in the Hanzo Flow repository](https://github.com/hanzoai/flow/issues) is actively updated with bugs and feature requests.
...
Use the [Hanzo Flow repository's labels](https://github.com/hanzoai/flow/labels) to help filter your search.
:::

## GitHub discussions

If you need help with your code or Hanzo Flow in general, you can visit the [Hanzo Flow GitHub Discussions page](https://github.com/hanzoai/flow/discussions) or reach out through other [Hanzo Flow community](/contributing-community) channels.

The Hanzo Flow team doesn't provide individual support over email, and the team believes that public discussions help more users by virtue of their discoverability.

## Community guidelines and tips

Because the Issues and Discussion pages are public, the Hanzo Flow team asks that you follow these guidelines when submitting questions and issues:

* **Provide as many details as possible**: Simply stating that a feature doesn't work isn't helpful. The Hanzo Flow team needs details in order to recreate and find the issue.
...
* **Retrace your steps**: Explain what happened before the error, what you expected to happen instead of the error, and any recent changes you made, such as upgrading Hanzo Flow or a dependency.
* **Describe your environment**: Include your operating system, Hanzo Flow version, Python version, and any other environment-related details that could have contributed to the issue.
