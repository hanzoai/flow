...
################################
# 1.27 — core/go.mod declares `go 1.27.1`, and the golang images pin
...
#   go: go.mod requires go >= 1.27.1 (running go 1.23.12; GOTOOLCHAIN=local)
...
FROM golang:1.27.1-bookworm AS goweb
