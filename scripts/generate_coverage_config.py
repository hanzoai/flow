...
def main():
    ...
    backend_components_path = project_root / "src" / "backend" / "base" / "flow" / "components"
    ...
    print("cd src/backend && python -m pytest --cov=src/backend/base/flow --cov-config=.coveragerc")
