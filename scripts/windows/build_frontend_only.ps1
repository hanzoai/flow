...
Write-Host "Starting Hanzo Flow frontend build process..." -ForegroundColor Green
...
Write-Host "You can now run the backend with: uv run flow run" -ForegroundColor Cyan
Read-Host "Press Enter to exit"